...
#Initializing score variable and update it as time passes 
score = 0
#and create a variable holding when the current game has started
start_time = 0
...
while True:
    ...
    if game_active:
        ...
        #Use pygame.time.get_ticks() method to get the current time in milliseconds, 
        #and subtract the start time to calculate the actual current game start time
        curr_time = pygame.time.get_ticks() - start_time
        #then update score as time passes, considering making score NOT in millisec 
